    ...
    <AuthLayout title="Create account" subtitle="Start tracking your rides & earnings for free">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="relative py-2">
          ...
          <div className="relative flex justify-center"><span className="bg-white dark:bg-gray-900 px-3 text-xs text-muted dark:text-gray-400 font-medium">or continue with</span></div>
        </div>
        ...
        <p className="text-center text-sm text-muted dark:text-gray-400">
          ...
          <Link to="/login" className="text-royal dark:text-blue-400 font-bold hover:text-navy dark:hover:text-white transition-colors">
            Sign in →
          </Link>
        </p>
      </form>
