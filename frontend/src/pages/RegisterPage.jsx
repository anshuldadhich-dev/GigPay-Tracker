      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="relative py-2">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-border dark:border-[#2A3650]" />
          </div>
          <div className="relative flex justify-center">
            <span className="bg-white dark:bg-[#1C2333] px-3 text-xs text-muted dark:text-[#8B9DC3] font-medium">or continue with</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-muted dark:text-[#8B9DC3]">
          ...
          <Link to="/login" className="text-royal dark:text-[#6EA8FE] font-bold hover:text-navy dark:hover:text-[#93C5FD] transition-colors">
            Sign in →
          </Link>
        </p>
      </form>
